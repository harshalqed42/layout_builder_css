 ...
 */
class LayoutBuilderCssFormBase extends EntityForm {
    /**
     * A logger instance.
     *
     ...
     * The Asset entity.
     *
     * @var \Drupal\layout_builder_css\LayoutBuilderInterface
     */
    protected $entity;
    /**
    ...
    public static function create(ContainerInterface $container) {
        return new static(
            $container->get('logger.factory')->get('layout_builder_css'),
    ...
    public function form(array $form, FormStateInterface $form_state) {
        ...
        /** @var \Drupal\layout_builder_css\Entity\LyoutBuilderCssBase $entity */
        $entity = $this->entity;
        $form['label'] = [
            '#type' => 'textfield',
            '#title' => $this->t('Label'),
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        \Drupal::logger('layout_builder_css')->info('Enters Submit form');
